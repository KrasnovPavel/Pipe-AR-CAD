...
using UnityEngine;
    ...
    public class GlTFImporter : Singleton<GlTFImporter>
    {
        ...
        private async void FormMeshesFromglTF(GameObject currentNodeGameObject, node currentNode, root rootOfglTFFile)
        {
            ...
            currentNodeGameObject.transform.localPosition = new Vector3(currentNode.translation[0],
                currentNode.translation[1], currentNode.translation[2]);
            currentNodeGameObject.transform.localScale =
                new Vector3(currentNode.scale[0], currentNode.scale[1], currentNode.scale[2]);
            ...
            foreach (primitive currentMeshPrimitive in currentMesh.primitives)
            {
                ...
                accessor indicesAccessor =
                    rootOfglTFFile.accessors[currentMeshPrimitive.indices]; //TODO: нормали + материалы
                ...
                string positionBufferWithoutPrefix =
                    positionBuffer.uri.Substring(glTFConvertionConsts.bufferPrefix.Length);
                string indicesBufferWithoutPrefix =
                    indicesBuffer.uri.Substring(glTFConvertionConsts.bufferPrefix.Length);
                ...
                MemoryStream indicesMemoryStream = new MemoryStream(indicesBytes, indicesBufferView.byteOffset,
