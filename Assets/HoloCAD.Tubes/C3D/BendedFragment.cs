...
namespace HoloCAD.Tubes.C3D
{
    public class BendedFragment : TubeFragment
    {
            ...
            : base(sys, diameter, parent)
        {
            ...
            _rightAxisRotationPattern.AddObject(_pivotAxis, Mathf.Deg2Rad * rotation, GCMAlignment.Rotated,
                                                GCMScale.GCM_RIGID);
            _rightAxisBendPattern = sys.CreateAngularPattern(_pivotAxis, _bendAxis, GCMAlignment.Cooriented);
            _rightAxisBendPattern.AddObject(RightAxis, -Mathf.Deg2Rad * bendAngle, GCMAlignment.Rotated,
                                            GCMScale.GCM_RIGID);
        ...
        {
            get => Mathf.Acos(1 - (EndCircle.Origin - StartCircle.Origin).magnitude
                              * (EndCircle.Origin - StartCircle.Origin).magnitude
                              / 2 / BendRadius / BendRadius)
                   * Mathf.Rad2Deg;
            //     // set
            //     // {
