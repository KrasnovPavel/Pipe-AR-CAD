...
namespace HoloCore.GLTF
{
    ...
    public static class GLTFConversionConsts
    {
    ...
    public class node
    {
        ...
        /// <summary> Вектор масштаба в узле. </summary>
    ...
    public class material
    {
        ...
        public Color Color
        {
            get
            {
                float[] GLTFColor = pbrMetallicRoughness.baseColorFactor;
                return new Color(GLTFColor[0], GLTFColor[1], GLTFColor[2], GLTFColor[3]);
            }
